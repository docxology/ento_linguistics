...
| `_render_pdf_override.py` | Combined PDF via Pandoc/XeLaTeX; `{{KEY}}` substitution from `output/data/*.json` | `uv run python scripts/_render_pdf_override.py --strict-templates` |
