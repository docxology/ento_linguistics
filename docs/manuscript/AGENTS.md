...
- `fulltext_analysis.png` - Full-text parallel-layer statistics summary (same frozen schema as `statistical_analysis.png` over the PMC Open Access full-text corpus; registered as `fig:fulltext_analysis`)
