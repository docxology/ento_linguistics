...
| `03_methods.md` | Mixed-methodology framework (computational + discourse analysis), 8 numbered subsections |
| `04a_corpus_and_networks.md` | Corpus analysis, terminology networks, and framing analysis |
| `04b_domain_findings.md` | Domain-by-domain findings and longitudinal case studies |
...
| File | Section |
|------|---------|
| `S01a_text_and_extraction.md` | Text processing, term extraction, and semantic entropy API |
| `S01b_analysis_infrastructure.md` | Statistical, scoring, and visualization infrastructure API |
| `S02_supplemental_results.md` | Additional analysis tables and domain-specific details |
| `S03a_theoretical_extensions.md` | Theoretical extensions and network analysis |
| `S03b_case_studies.md` | Case studies and validation frameworks |
...
| `fig:terminology_network` | `04a_corpus_and_networks.md` | Terminology network across domains (Jaccard similarity) |
| `fig:domain_comparison` | `04a_corpus_and_networks.md` | 6-panel domain comparison (terms/confidence/frequency/entropy/bridging/CACE) |
| `fig:domain_overlap_heatmap` | `04a_corpus_and_networks.md` | Cross-domain term overlap heatmap |
| `fig:anthropomorphic_framing` | `04a_corpus_and_networks.md` | Anthropomorphic framing analysis (LinguisticFeatureExtractor) |
| `fig:concept_hierarchy` | `04b_domain_findings.md` | Concept network centrality — NetworkX degree/betweenness/eigenvector |
| `fig:domain_overview_grid` | `04b_domain_findings.md` | 6-panel top-10 terms per domain, colored by entropy |
| `fig:domain_patterns_grid` | `04b_domain_findings.md` | 6-panel POS composition donut charts per domain |
