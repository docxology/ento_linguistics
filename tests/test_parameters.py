...
class TestSimulationParameters:
    """Test SimulationParameters subclass."""

    def test_default_values(self):
        """Test SimulationParameters provides defaults for num_agents, num_steps, interaction_rate."""
        from core.parameters import SimulationParameters

        params = SimulationParameters()
        assert params.parameters["num_agents"] == 100
        assert params.parameters["num_steps"] == 1000
        assert params.parameters["interaction_rate"] == 0.1

    def test_override_defaults(self):
        """Test overriding default values."""
        from core.parameters import SimulationParameters

        params = SimulationParameters(num_agents=50, num_steps=500)
        assert params.parameters["num_agents"] == 50
        assert params.parameters["num_steps"] == 500
        # interaction_rate should still be default
        assert params.parameters["interaction_rate"] == 0.1

    def test_custom_kwargs(self):
        """Test passing custom keyword arguments."""
        from core.parameters import SimulationParameters

        params = SimulationParameters(custom_param="hello")
        assert params.parameters["custom_param"] == "hello"


class TestAnalysisParameters:
    """Test AnalysisParameters subclass."""

    def test_default_values(self):
        """Test AnalysisParameters provides defaults for min_term_freq, cooccurrence_threshold."""
        from core.parameters import AnalysisParameters

        params = AnalysisParameters()
        assert params.parameters["min_term_freq"] == 5
        assert params.parameters["cooccurrence_threshold"] == 2

    def test_override_defaults(self):
        """Test overriding default values."""
        from core.parameters import AnalysisParameters

        params = AnalysisParameters(min_term_freq=10)
        assert params.parameters["min_term_freq"] == 10
        assert params.parameters["cooccurrence_threshold"] == 2

    def test_custom_kwargs(self):
        """Test passing custom kwargs through to ParameterSet."""
        from core.parameters import AnalysisParameters

        params = AnalysisParameters(experiment_id="exp1")
        assert params.parameters["experiment_id"] == "exp1"
