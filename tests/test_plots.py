...
class TestPlotConceptNetwork:
    ...
    def test_concept_network_minimal(self):
    ...
    def test_concept_network_with_real_concept_map(self):
        ...
        cmap.add_concept(c2)
        cmap.add_concept(c3)
        cmap.add_relationship("colony", "worker", 0.8)
        cmap.add_relationship("colony", "queen", 0.9)
    ...
    def test_concept_network_custom_title(self):
        """Test concept network with custom title kwarg."""
        from analysis.conceptual_mapping import Concept, ConceptMap
    ...
    def test_concept_network_no_domains(self):
        """Test concept network with concepts that have no domains (fallback color)."""
        from analysis.conceptual_mapping import Concept, ConceptMap
