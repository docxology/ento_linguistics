...
class TestStatisticalSignificance:
    ...
    def test_estimate_complexity_nlogn(self):
        ...
        sizes = [10, 20, 30, 40, 50]
        # O(n log n) has a log-log slope of ~1.2-1.8 for practical sizes.
        # Use exponent 1.4 to land in the detection range.
        times = [s**1.4 / 10 for s in sizes]
        complexity = _estimate_complexity(sizes, times)
    ...
    def test_estimate_complexity_other(self):
        ...
        sizes = [10, 20, 30, 40, 50]
        # Custom exponent (e.g., 2.5) that falls outside all named ranges
        times = [s**2.5 / 100 for s in sizes]
        complexity = _estimate_complexity(sizes, times)
        assert "O(n^" in complexity
        assert "2.5" in complexity or "2.50" in complexity
