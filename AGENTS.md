...
├── _render_pdf_override.py       # (active) Custom PDF rendering override used by pipeline
...
├── S01a_text_and_extraction.md   # Supplemental methods: text processing and extraction
├── S01b_analysis_infrastructure.md # Supplemental methods: statistical infrastructure
