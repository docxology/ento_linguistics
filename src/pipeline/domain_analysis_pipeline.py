"""Domain analysis pipeline for Ento-Linguistic research.

Performs detailed analysis of specific Ento-Linguistic domains, examining
terminology patterns, framing assumptions, and communication clarity within
individual conceptual areas. Invoked via the thin orchestrator
``scripts/_domain_analysis_script.py``.
"""
...
class DomainAnalysisScript:
    ...
    def _generate_domain_report(
        ...
        # Precompute these sections outside the report f-string below:
