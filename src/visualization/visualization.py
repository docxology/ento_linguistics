"""Visualization engine for Ento-Linguistic research.

This module provides the core engine for generating publication-quality figures
illustrating entomological metaphors in scientific discourse.
"""
